...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_STATUS_CHANGED', 'TASK_ASSIGNED', 'PROJECT_CREATED', 'PROJECT_ARCHIVED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Task_projectId_orderIndex_key" ON "Task"("projectId", "orderIndex");
